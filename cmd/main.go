...
import (
	...
	"github.com/pyle-cloud-technologies/mirth-operator/internal/controller"
	_ "github.com/pyle-cloud-technologies/mirth-operator/internal/metrics" // register custom metrics on import
...
func init() {
	...
	utilruntime.Must(mirthv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "a24791f7.pyle.io",
	})
	if err != nil {
